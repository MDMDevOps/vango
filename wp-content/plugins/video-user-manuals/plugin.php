...
class Vum{
    ...
    {
        return function_exists('classic_editor_init_actions');
    ...
    function defineForm()
    {
        ...
        if($embed_status->status == 4){
            ...
            $form->addYesNo('use_wp_latest_videos', 'Use WordPress 5.0 Videos', '', 0);
    ...
    function display_vid_embedded( $video_id, $video ) {
        ...
        $url_data = array(
            ...
            'wp_version' => get_option( 'wpm_o_use_wp_latest_videos' ) ? '5.0' : 'default',
...
xxxx;
	...
	function video_shortcode_footer_js($atts) {
        ...
        $url->guttenburg = $this->guttenburg;
        $url->hce = $this->has_classic_editor();
        $url->wp_version = get_option( 'wpm_o_use_wp_latest_videos' ) ? '5.0' : 'default';
